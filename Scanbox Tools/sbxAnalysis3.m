...
%     colormap(GUIHandles.imageProcessing.imageAxes, gray);
    ...
    GUIHandles.imageProcessing.frameSlider = uicontrol('Parent', GUIHandles.imageProcessingTab, 'Style', 'slider', 'Min', 0, 'Max', GUIHandles.Info.maxIndex, 'Value', 0, 'SliderStep', [1/GUIHandles.Info.maxIndex, 500/GUIHandles.Info.maxIndex], 'Units', 'normalized', 'Position', [0.0075, GUIHandles.imageProcessing.imageTypeButtonGroup.Position(2) - 0.0175, 0.085, 0.015], 'Callback', @frameSliderCallback);
...
function extractFluorescencesCallback(GUI, ~)
    ...
    if nnz(GUIHandles.roiDrawing.roiMask) > 0
        ...
        progressBar = waitbar(0, 'Extracting fluorescences...', 'Name', 'Extracting Fluorescences', 'CreateCancelBtn', 'setappdata(gcbf, ''Canceling'', 1)');
        setappdata(progressBar, 'Canceling', 0);
