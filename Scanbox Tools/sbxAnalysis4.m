...
%         set(0, 'CurrentFigure', temp_fig)
        ...
        if normcorreCorrection == true
            ...
            options_nonrigid = NoRMCorreSetParms('d1',size(Y,1),'d2',size(Y,2),'grid_size',[64,64],'mot_uf',2,'bin_width',200,'max_shift',15,'max_dev',3,'us_fac',50,'init_batch',200,'correct_bidir',false);
            tic; [M2,shifts2,template2,options_nonrigid] = normcorre_batch(Y,options_nonrigid); toc
