function run_glm_func_newc(FILE, MOUSE)
...
for ROI=1:ROI_amount
    ...
    spike_rate_1 = smooth(dF_ds(ROI,:).');
    min_rate = ones(length(spike_rate_1),1);
    b = robustfit(min_rate,spike_rate_1);
    spike_rate_0 = spike_rate_1 - b(1)*min_rate;
