function final_res = make_reward_predicts_long(behave, pred)
...
animal_location_long_idx = behave(:,5) == 4; % behav_ds[:,4] in python
animal_location = behave(animal_location_long_idx,2); % behav_ds[animal_location_short_idx,1] in python
lick_location = behave(animal_location_long_idx,8); % behav_ds[animal_location_short_idx,1] in python
reward_location = behave(animal_location_long_idx,6); % behav_ds[animal_location_short_idx,5] in python
