...
def fig_dfloc_openloop_speed(h5path, sess, roi, fname, fformat='png', subfolder=[], c_ylim=[]):
    ...
    ax9.set_title('short, 10 cm/sec')
    ax10.set_title('short, 30 cm/sec')
    ax11.set_title('long, 10 cm/sec')
    ax12.set_title('long, 30 cm/sec')
    ...
    if np.size(behav_ds,1) > 8:
        ...
        trials_active_short = filter_trials( behav_ds, [], ['running_speed',10.0], trials_short)
        ...
        trials_passive_short = filter_trials( behav_ds, [], ['running_speed',30.0], trials_short)
        ...
        trials_active_long = filter_trials( behav_ds, [], ['running_speed',10.0], trials_long)
        ...
        trials_passive_long = filter_trials( behav_ds, [], ['running_speed',30.0], trials_long)
