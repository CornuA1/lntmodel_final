...
def fig_dfloc_trace_roiparams(h5path, sess, roi, fname, align_point, peak_locs, filterprops_short_1, filterprops_short_2, filterprops_long_1, filterprops_long_2, fformat='png', subfolder=[], c_ylim=[], make_figure=True, load_raw=False,use_data='aligned_data.mat', is_ol_sess=False):
    ...
    if load_raw == False:
        df_signal_path = h5path + '_' + sess + use_data
        behavior_path = h5path + '_' + sess + '_behavior_aligned.mat'
...
#        print('number of rois: ' + str(NUM_ROIS))
        df_signal_path = h5_filepath + '_' + sessionname + use_data
        behavior_path = h5_filepath + '_' + sessionname + '_behavior_aligned.mat'
...
#        roilist = lotalota
    ...
    for r in roilist:
        ...
        if ol_sess:
            ...
            fig_dfloc_trace_roiparams(h5path, SESSION_OPENLOOP, r, MOUSE+'_'+SESSION+'_roi_'+str(r), align_point, [meanpeak_short_loc, meanpeak_long_loc], ['animal_running',3,meanpeak_short_loc,[120,120], True, trial_onset],  ['animal_running',3,meanpeak_short_loc,[120,120], False, trial_onset],['animal_running',3,meanpeak_long_loc,[50,50], True, trial_onset],  ['animal_running',3,meanpeak_long_loc,[50,50], False, trial_onset], fformat, subfolder_ol, c_ylim, make_figure, load_raw,use_data,True)
...
def run_for_mouse(MOUSE, sessions):
    ...
    for s in sessions:
        data_path = 'C:/Users/lfisc/Work/Projects/Lntmodel/data_2p/dataset' + os.sep + MOUSE
        base_path = 'C:/Users/lfisc/Google Drive/MTH3_data/animals_raw'
        SESSION = '2019'+s
        SESSION_OPENLOOP = '2019' + s + '_ol'
        use_data = '_dF_aligned.mat'
