"""
Plot trace of an individual ROI centered around the reward location

@author: lukasfischer

"""

def fig_reward_centered(h5path, sess, roi, fname, ylims=[-0.5,3], fformat='png'):
    import numpy as np
    import h5py
    import sys
    import yaml
    ...
    events = event_ind(behav_ds,['rewards_all',-1])
    ...
    fig.suptitle('Reward' + fname, wrap=True)
    fname = content['figure_output_path'] + 'rew_cen_' + fname + '.' + fformat
    print(fname)
