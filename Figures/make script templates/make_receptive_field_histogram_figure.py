...
from receptive_field_histogram_figure import receptive_field_histogram_figure
...
figure_name = 'receptive field histogram - L23'
receptive_field_histogram_figure(L23_mice, figure_name, 'svg', '#666666')
                                 
figure_name = 'receptive field histogram - L5'
receptive_field_histogram_figure(L5_mice, figure_name, 'svg', '#B000BE')