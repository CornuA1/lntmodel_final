...
def popvloc_individual(r, trials, celltypes, split_data, align_point, binnr_short, binnr_long, maxlength_short, maxlength_long, sortby, fname, tot_rois_short, tot_rois_long, trial_by_trial = False, make_individual_figure=True, subfolder='', firstlick_split = None, custom_rois_short=None, custom_rois_long=None, roi_union=False):
    ...
    # ipdb.set_trace()
    roiIDs_short = [rd.item() for rd in roiIDs[roi_selection_short]]
    roiIDs_long = [rd.item() for rd in roiIDs[roi_selection_long]]
...
def fig_popvloc_naiveexpert(roi_param_list, celltypes=['trialonset','lmcenter','reward'], reward_distance=0, trials='both', sortby='both', split_data=True, align_point = 'landmark', fname='', subfolder='', write_to_dict=False, sort_VR=None, which_cc='expert_naive'):
    ...
    for current_iter in range(NUM_ITER):
        ...
        for r in roi_param_list:
            ...
            _,_,_,_, \
            roi_selection_short_expert, roi_selection_long_expert = \
                popvloc_individual(r[0], trials, celltypes, True, align_point, binnr_short, binnr_long, maxlength_short, maxlength_long, sortby, fname, tot_rois_short, tot_rois_long, TRIAL_BY_TRIAL, True, subfolder, None, roi_selection_short_expert, roi_selection_long_expert, False)
            ...
            # _,_,_,_, \
            # roi_selection_short_expert, roi_selection_long_expert = \
            #     popvloc_individual(r[1], trials, celltypes, True, align_point, binnr_short, binnr_long, maxlength_short, maxlength_long, sortby, fname, tot_rois_short, tot_rois_long, TRIAL_BY_TRIAL, True, subfolder, None, roi_selection_short_expert, roi_selection_long_expert, False)
...
if __name__ == "__main__":
    ...
    roi_param_list = [
                      [[loc_info['figure_output_path'] + 'LF191022_3' + os.sep + 'LF191022_3_20191119' + suffix + '.json','LF191022_3','20191119'], [loc_info['figure_output_path'] + 'LF191022_3' + os.sep + 'LF191022_3_20191204' + suffix + '.json','LF191022_3','20191204']],
                     ]

    fig_popvloc_naiveexpert(roi_param_list, ['trialonset','lmcenter','reward'], reward_distance, 'both', 'both', True, 'landmark', 'all_landmark_naiveexpert', 'popvloc', write_to_dict, None, 'expert_naive')
