...
cellreg_data = load('D:\Lukas\roi results\cellRegistered_LF191023_blue_04_reg_ol');
...
MOUSE = 'LF191023_blue';
SESSION = ['20191204___';'20191204_ol'];
numb = size(SESSION,1);
comb_mat = [];
...
save(strcat(loc_info.raw_dir(2:end-1), MOUSE, '\',MOUSE,'_coef_matched_23_04_x_histo.mat'),'save_short','save_long','save_short_x','save_long_x')
