    ...
    with open("{0}.csv".format(fname), 'w') as config_file:
        ...
        for i in range(lines):
            ...
            if random.choice([False,True]):
                ...
                config_file.write('track;{0};prelick;1.0;gain modulation;1.0;rewarded;1;Reset;{1};RZ start;{2}.0;RZ end;{3}.0;landmark;{4}.0;default;{5};openloop;-1;bbreset;0;opto_mask;0;opto_stim;0;\n'.format(tracktype,t_reset,rz_start,rz_end,landmark,default))
                previous_opto_stim = False

if __name__ == "__main__":
    mouse = 'LF180728'
    make_config_MTH3_VD('MTH3_s5v1_opto_' + mouse + '_1001', 400, [3,4], 0, mouse)
