...
def make_config_MTH3_VD(fname, lines, tracknrs, mousename=[]):
    ...
    with open("{0}.csv".format(fname), 'w') as config_file:
        config_file.write('Experiment;MTH3_vr2_opto;Length (min);60;Day;1;ExpGroup;1;Mouse;{0};DOB;00000000;Strain;C57;Stop Threshold;0.7;Valve Open Time;0.3;Comments;no\n'.format(mousename))
        for i in range(lines):
            track = random.choice(tracknrs)
            if track == 3:
                if random.choice([1,2,3,4,5]) == 5:
                    config_file.write("track;3;prelick;1.0;gain modulation;0.5;rewarded;1;Reset;400;RZ start;320.0;RZ end;340.0;landmark;240.0;default;340;openloop;-1;bbreset;0;\n")
                else:
                ...
                if random.choice([1,2,3,4,5]) == 5:
                    config_file.write("track;4;prelick;1.0;gain modulation;0.5;rewarded;1;Reset;460;RZ start;380.0;RZ end;400.0;landmark;240.0;default;400;openloop;-1;bbreset;0;\n")
                else:
...
if __name__ == "__main__":
    make_config_MTH3_VD('MTH3_s5r_gm', 400, [3,4], 'C57')
